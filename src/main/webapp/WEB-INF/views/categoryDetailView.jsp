...
<head>
  ...
  <title>Thông tin Loại thức uống #${requestScope.category.id}</title>
</head>
...
<section class="section-content">
  <div class="container">
    <header class="section-heading py-4">
      <h3 class="section-title">Thông tin Loại thức uống</h3>
    ...
    <div class="card mb-5">
      <div class="card-body">
        <dl class="row">
          ...
          <dt class="col-md-3">Tên Loại thức uống</dt>
          <dd class="col-md-9">
          ...
          <dt class="col-md-3">Mô tả Loại thức uống</dt>
          <dd class="col-md-9">${requestScope.category.description}</dd>

          <dt class="col-md-3">Hình Loại thức uống</dt>
          <dd class="col-md-9">
            <c:choose>
