...
<head>
  ...
  <title>Sửa Loại thức uống</title>
</head>
...
<section class="section-content">
  <div class="container">
    <header class="section-heading py-4">
      <h3 class="section-title">Sửa Loại thức uống</h3>
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/categoryManager/update"
        ...
        <div class="mb-3">
          <label for="category-name" class="form-label">Tên Loại thức uống <span class="text-danger">*</span></label>
          <input type="text"
        ...
        <div class="mb-3">
          <label for="category-description" class="form-label">Mô tả Loại thức uống</label>
        ...
        <div class="mb-3">
          <label for="category-imageName" class="form-label d-block">Hình Loại thức uống</label>
          <c:choose>
